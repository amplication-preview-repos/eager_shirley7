...
export class JobResolverBase {
  ...
  async createJob(@graphql.Args() args: CreateJobArgs): Promise<Job> {
    return await this.service.createJob({
      ...
      data: {
        ...
        retouchTask: args.data.retouchTask
          ? {
              connect: args.data.retouchTask,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => RetouchTask, {
    nullable: true,
    name: "retouchTask",
  })
  @nestAccessControl.UseRoles({
  ...
  async getRetouchTask(
    @graphql.Parent() parent: Job
  ): Promise<RetouchTask | null> {
    const result = await this.service.getRetouchTask(parent.id);
